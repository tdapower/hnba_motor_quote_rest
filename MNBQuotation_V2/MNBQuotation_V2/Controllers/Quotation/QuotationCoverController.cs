...
{
    public class QuotationCoverController : ApiController
    {
        ...
        //[HttpPost]
        //public HttpResponseMessage AddQuotationCoverDetails(string JobId, string RevisionId, List<QuotationCover> quotationCovers)
        //{
        ...
        //    DeleteCovers(Convert.ToInt32(JobId), Convert.ToInt32(RevisionId));

        //    foreach (QuotationCover cover in quotationCovers)
        //    {
        ...
        //        defaultCoverCodes[0] = "chk18";
        //        defaultCoverCodes[1] = "chk19";
        //        defaultCoverCodes[2] = "chk24";
        //        defaultCoverCodes[3] = "chk26";
        ...
        //                allowedMaxMR = getRelevantMRRate(quotationMain.RiskTypeId, quotationMain.VehicleUsageId, quotationMain.FuelTypeCode, quotationMain.SumInsured, user.company,quotationMain.MakeModelCode,quotationMain.YearOfManufactureValidationId);


        //                SaveDefaultCovers(quotationMain.JobId, quotationMain.RevisionNo, defaultCoverCodes[a], allowedMaxMR.ToString());
        //            }
        //            else
        //            {
        //                SaveDefaultCovers(quotationMain.JobId, quotationMain.RevisionNo, defaultCoverCodes[a], "0");
        //            }
        ...
        public void DeleteCovers(int jobId, int revisionId)
        {
            ...
            cmd.CommandText = "delete from MNB_POLICY_COVER_LIST t  where t.JOB_ID=:V_JOB_ID AND REVISION_NO=:V_REVISION_NO";
